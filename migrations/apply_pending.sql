-- Apply pending migrations 0002, 0003, 0004 via raw SQL
-- (Alembic unavailable inside containers due to no internet)
...
-- so we commit above and start a new transaction for the remaining DDL.
...
--    (matches the legacy token_balances seed from 01_schema.sql)
